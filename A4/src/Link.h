...
public:
	...
	void setPosition(double x, double y) { position << x, y, 0.0; }
	...
	void drawMesh(const std::shared_ptr<Program> prog, std::shared_ptr<MatrixStack> MV, const std::shared_ptr<Shape> shape) const;
